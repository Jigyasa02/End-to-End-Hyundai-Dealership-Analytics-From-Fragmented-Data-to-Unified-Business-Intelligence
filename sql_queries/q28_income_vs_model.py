...
SELECT 
    ...
    b.model_name,
    COUNT(*) as purchases,
    ROUND(AVG(i.total_amount), 0) as avg_spent
FROM customers c
JOIN bookings b 
...
GROUP BY c.income_bracket, b.model_name
ORDER BY c.income_bracket, purchases DESC
"""
...
print("Q28: INCOME vs MODEL PREFERENCE")
print("-" * 50)
